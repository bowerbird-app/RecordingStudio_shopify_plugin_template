...
class DocsController < ApplicationController
  ...
  def gem_views
    prefix = "#{RecordingStudioShopifyPluginTemplate::Engine.root}/"

    @engine_views = Dir.glob(RecordingStudioShopifyPluginTemplate::Engine.root.join("app/views/recording_studio_shopify_plugin_template/**/*.erb").to_s)
      .sort
