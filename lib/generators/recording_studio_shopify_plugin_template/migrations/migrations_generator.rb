...
module RecordingStudioShopifyPluginTemplate
  module Generators
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioShopifyPluginTemplate migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioShopifyPluginTemplate engine.", :yellow
          return
        end
