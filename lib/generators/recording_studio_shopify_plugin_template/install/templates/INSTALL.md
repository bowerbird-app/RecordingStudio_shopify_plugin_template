RecordingStudioShopifyPluginTemplate install complete.

Next steps:

1. Review config/initializers/recording_studio_shopify_plugin_template.rb and set any required options.
2. If you use environment-specific settings, create config/recording_studio_shopify_plugin_template.yml.
3. Install the engine migrations with `bin/rails generate recording_studio_shopify_plugin_template:migrations`.
